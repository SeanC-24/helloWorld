...
with app.app_context():
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,'email': 'leovan@umd.edu',
         'birth_date': dt.datetime(2008, 3, 24), 'is_honors': 0},
    ]
    # added email for each student so that every student entered in the database has a corresponding email
