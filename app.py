...
def student_create():
    if request.method == 'GET':
        ...
        # added email so that when the form is submitted the new student added will have an email that they entered
...
def student_edit(student_id):
    if request.method == 'GET':
        ...
        student = Student.query.filter_by(student_id=student_id).first()
        # added email so that when the form is edited the new student added will have an email that they entered
        if student:
...
def hello_world():  # put application's code here
    return 'Hello World from Sean Clark! I am adding my first code change.'
